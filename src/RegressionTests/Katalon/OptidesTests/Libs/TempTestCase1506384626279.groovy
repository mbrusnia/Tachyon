...
RunConfiguration.setExecutionSettingFile('C:\\Users\\Hector\\AppData\\Local\\Temp\\Katalon\\Test Cases\\HPLC Image Assay Pipeline\\20170925_171026\\execution.properties')
...
not_run: WebUI.click(findTestObject('Page_Assay Dashboard HTProduction/link_Assays'))

not_run: WebUI.click(findTestObject('Page_Assay Dashboard HTProduction/link_HPLC Assays'))

not_run: WebUI.click(findTestObject('Page_Assay Dashboard HTProduction/chkbx_HPLC_HT0102'))

not_run: WebUI.click(findTestObject('Page_Assay Dashboard HTProduction/btn_Delete'))
