...
RunConfiguration.setExecutionSettingFile('C:\\Users\\Hector\\AppData\\Local\\Temp\\Katalon\\Test Cases\\postTest-RemoveTestConstructs\\20170928_180020\\execution.properties')
...
not_run: WebUI.click(findTestObject('Page_Assay Dashboard OptidesCompoun/a_Homologue'))
...
WebUI.click(findTestObject('Page_Assay Dashboard OptidesCompoun/div_Received By'))

WebUI.click(findTestObject('Page_Sample Set Construct OptidesCo/span_Filter...'))

WebUI.setText(findTestObject('Page_Sample Set Construct OptidesCo/input_value_1'), 'TESTTEST')
