...
RunConfiguration.setExecutionSettingFile('C:\\Users\\Hector\\AppData\\Local\\Temp\\Katalon\\Test Cases\\HT_DNA Delivery.R\\20180215_151612\\execution.properties')
...
not_run: WebUI.click(findTestObject('Page_Assay Dashboard OptidesCompoun/radioBtn_Upload_HT_Delivery'))

not_run: WebUI.click(findTestObject('Page_Assay Dashboard OptidesCompoun/button_Import'))

not_run: WebUI.delay(3)

not_run: if (WebUI.verifyElementVisible(findTestObject('Page_Data Pipeline - CompoundsRegistry/input_Name'), FailureHandling.CONTINUE_ON_FAILURE)) {
...
not_run: if (!(url.endsWith('pipeline-status/Optides/CompoundsRegistry/Samples/showList.view?'))) {
...
not_run: while ((pipelineStatus == 'ht_delivery RUNNING') || (pipelineStatus == 'ht_delivery WAITING')) {
    WebUI.delay(10)
...
''', 'Test Cases/HT_DNA Delivery.R', new TestCaseBinding('Test Cases/HT_DNA Delivery.R', [:]), FailureHandling.STOP_ON_FAILURE )
