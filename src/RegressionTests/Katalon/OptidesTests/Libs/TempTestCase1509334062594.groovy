...
RunConfiguration.setExecutionSettingFile('C:\\Users\\Hector\\AppData\\Local\\Temp\\Katalon\\Test Cases\\AssayReport Creation test\\20171029_202742\\execution.properties')
...
not_run: WebUI.click(findTestObject('Page_Assay Dashboard OptidesCompoun/btn_Submit'))

not_run: WebUI.verifyTextPresent('testAssayReport-', false)

not_run: WebUI.verifyTextPresent('Name', false)

not_run: WebUI.verifyTextPresent('NetChargeAtpH7_4', false)

not_run: WebUI.verifyTextPresent('ReducedForm_pI', false)

not_run: WebUI.click(findTestObject('Page_Assay Dashboard OptidesCompoun/a_Admin'))

not_run: WebUI.click(findTestObject('Page_Assay Dashboard OptidesCompoun/span_Manage_Views'))

not_run: WebUI.setText(findTestObject('Page_Assay Dashboard OptidesCompoun/input_Filter'), 'testAssayReport-')

not_run: WebUI.click(findTestObject('Page_Assay Dashboard OptidesCompoun/span_EditPencil'))

not_run: WebUI.click(findTestObject('Page_Assay Dashboard OptidesCompoun/btn_Delete'))
