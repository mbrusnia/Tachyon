...
WebUI.click(findTestObject('Page_Assay Dashboard OptidesCompoun/file_newChemProducts_input.xlsx'))

WebUI.click(findTestObject('Page_Assay Dashboard OptidesCompoun/span_Import Data'))

WebUI.click(findTestObject('Page_Assay Dashboard OptidesCompoun/radioBtn_InsertNewCHEMProducts'))
...
while ((pipelineStatus == 'insert_chemical_product RUNNING') || (pipelineStatus == 'insert_chemical_product WAITING')) {
    WebUI.delay(10)
