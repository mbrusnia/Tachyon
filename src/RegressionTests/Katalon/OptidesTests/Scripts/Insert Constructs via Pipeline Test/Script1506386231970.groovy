...
WebUI.click(findTestObject('Page_Assay Dashboard OptidesCompoun/file_TESTinsertConstructsThroughPipeline.xml'))

WebUI.click(findTestObject('Page_Assay Dashboard OptidesCompoun/span_Import Data'))

WebUI.click(findTestObject('Page_Assay Dashboard OptidesCompoun/label_Insert New Construct Seq'))
...
while ((pipelineStatus == 'insert_constructs RUNNING') || (pipelineStatus == 'insert_constructs WAITING')) {
    WebUI.delay(10)
